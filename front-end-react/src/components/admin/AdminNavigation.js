...
<Navbar variant="dark" bg="dark" expand="lg">
  <Container fluid>
    <Navbar.Brand href="#home"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" marginRight="5"  fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
